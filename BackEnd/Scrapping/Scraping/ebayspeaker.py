...
for i in range(1,3):
    driver.get(
        f"https://www.ebay.com/sch/i.html?_from=R40&_nkw=speaker&_sacat=0&_ipg=240&_pgn={i}&rt=nc"
    )
...
if products:
    ...
    file_exists = os.path.isfile("EbaySpeakerData.csv")

    # Write to the CSV file
    df.to_csv("EbaySpeakerData.csv", mode="a", header=not file_exists, index=False, encoding="utf-8", errors="replace")
